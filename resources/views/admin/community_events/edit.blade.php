        ...
        <form action="{{ route('admin.community-events.update', $community_event) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  rows="5" 
                                  required
                                  placeholder="Describe what this event is about...">{{ old('description', $community_event->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="button_text" 
                                       name="button_text" 
                                       value="{{ old('button_text', $community_event->button_text) }}" 
                                       maxlength="100">
                                @error('button_text')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="url" 
                                       ...
                                       id="button_url" 
                                       name="button_url" 
                                       value="{{ old('button_url', $community_event->button_url) }}" 
                                       maxlength="255"
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               id="icon" 
                               name="icon" 
                               value="{{ old('icon', $community_event->icon) }}" 
                               maxlength="100">
                        @error('icon')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="mt-2 p-2 bg-light rounded text-center" id="icon-preview">
                            <i class="{{ old('icon', $community_event->icon) }} fa-3x text-primary"></i>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if($community_event->image_path)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $community_event->image_path) }}" 
                        ...
                        @enderror
                        <div class="form-text">
                            Allowed formats: JPEG, PNG, JPG, GIF (Max: 2MB). Leave empty to keep current image.
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" 
                               ...
                               id="event_date" 
                               name="event_date" 
                               value="{{ old('event_date', $community_event->event_date ? $community_event->event_date->format('Y-m-d') : '') }}">
                        @error('event_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input" 
                                   ...
                                   name="is_active" 
                                   value="1" 
                                   {{ old('is_active', $community_event->is_active) ? 'checked' : '' }}>
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> Update Community Event
                </button>
            </div>
        </form>
    </div>

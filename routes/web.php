...
Route::get('/', function () {
    ...
    try {
        $communityEvents = CommunityEvent::active()
            ->ordered()
            ->get();
    } catch (\Exception $e) {
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin.auth'])->group(function () {
        ...
        Route::resource('community-events', \App\Http\Controllers\Admin\CommunityEventController::class)->except(['show']);
        Route::post('community-events/{community_event}/toggle-status', [\App\Http\Controllers\Admin\CommunityEventController::class, 'toggleStatus'])->name('community-events.toggle-status');

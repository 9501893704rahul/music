...
<head>
    ...
    <style>
        /* Submit Button Color */
        .btn-primary {
            background-color: #0d6efd !important; /* Default primary color */
        ...
        .open > .dropdown-toggle.btn-primary {
            background-color: #ebe305 !important; /* Hover state */
            border-color: #ebe305 !important;
        }
        
        /* Global Body Styling */
        body {
            background: linear-gradient(120deg, #053df7, #ebe305);
        ...
        .card-header {
            ...
            background: linear-gradient(90deg, #fbfeae, #f1f1ef);
            color: #000000;
